...
public class MatrixGen {
    ...
    MTRandom rng = new MTRandom();
    private double vectors[][];
    private double vector[];
    public static double foxholeC[] = {0.806,0.517,0.1,0.908,0.965,0.669,0.524,0.902,0.351,0.876,0.462,
                        0.491,0.463,0.741,0.352,0.869,0.813,0.811,0.0828,0.964,0.789,0.360,0.369,
                        0.992,0.332,0.817,0.632,0.883,0.608,0.326};
    public static double foxholeA[][] = {{9.681,0.667,4.783,9.095,3.517,9.325,6.544,0.211,5.122,2.02}, 
    ...
    //Use MTRandom to create a 2d matrix for application in project 1
    public double[][] createMatrix(int dimension, double lowBound, double upBound){
        vectors = new double[30][dimension];
        for (int i = 0; i < 30; i++){
            for(int j = 0; j < dimension; j++){
                double n = (double)rng.next(64);
                if(lowBound == 0){
                    n = Math.abs(n);
                }
                n = n % upBound;
    ...
    //Use MTRandom to create an array for application in projects 1 or 2
    public double[] createArray(int dimension, double lowBound, double upBound){
